...
$request_id = REQ_UTS_.$acc->requestSequence();
...
if (!is_array($cif)) {
	...
	<FIXML xsi:schemaLocation="http://www.finacle.com/fixml CustInq.xsd" xmlns="http://www.finacle.com/fixml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
        ...
        $id_no = $xml->Body->CustInqResponse->CustInqRs->EntityDocInfo->UniqueId;
        ...
        if ($customerId == "") {
            ...
            /*
             * @
              save account/member details to a temporary database table for later use
            *
             * display details
             */
            ?>
