    ...
    public function member_registration_v2($data_) {
        ...
        try {
            ...
            $QrtStrMember = "INSERT INTO members (member_no, title, firstname, surname, othernames, allnames, "
                . "post_address, phys_address, hse_no, town, country, gsm_no,e_mail, id_no, dob,gender, maritalstatus, "
                ...
                . ":phys_address, :hse_no, :town, :country, :gsm_no,:e_mail, :id_no, :dob,:gender,  :marital_status,:comments, "
                . ":tax_exempt, :resident,  :branch_id, :branch_name,:sms_notify, :sms_query, :statement_via, 1)";
