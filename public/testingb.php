...
if (is_array($transactions)) {
    ...
    foreach ($transactions as $trans) {
        ...
        $test->Cell(15, 8, $functions->formatMoney($purchaseprice, true), 1, 0, "R");
        ...
        $test->Cell(15, 8, $functions->formatMoney($trans->NAV, true), 1, 0, "R");
        $y += 8;
...
//generated by
$test->Cell(100, 10, "Printed by: " . $_SESSION['username']);
// Page number
