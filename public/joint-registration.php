...
$request_file = $lib->encryptStringArray('joint', 'token321');
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="registered-members"><i class="glyphicon glyphicon-users"></i> Registered Clients</a></li>
                                ...
                                <fieldset>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="joint_name">Joint Account Name:</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="text">Effective Date:</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i
                                                        class="fa fa-calendar"></i> </span>
                                                <input type="text" name="effective_date" class="form-control"
                                                       id="idno" value="<?php echo date('Y-m-d') ?>"
                                                       data-provider="datepicker" data-date-end-date="0d"
                                                       data-error="Date is invalid" required
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="text">Mobile Phone Number:</label>
