...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Short Message Settings</li>
        </ol>
    </section>
            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">View and edit Settings</h3>
                    ...
                    <div class="box-body with-border">
                        ...
                        <div class="box body  box-warning">
                            <table class="table table-hover table-bordered" id="user-transfer">
                                ...
                                <?php
                                echo "<tr>";
                                echo "<td >" . $settings->smssenderid . "</td>";
                                echo "<td >" . $settings->smsurl . "</td>";
                                echo "<td >" . $settings->smsusername . "</td>";
                                echo "<td >" . $settings->smstrainingmsg . "</td>";
                                echo "<td ><a href=#></i>&nbsp;&nbsp;Edit</a></td>";
                                echo "</tr>";
