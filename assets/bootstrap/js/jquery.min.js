...
(function (a, b) {
    ...
    bW = bR.exec(bV.toLowerCase()) || [], f.fn.extend({load: function (a, c, d) {
        ...
        return a
    }, ajaxSettings: {url: bV, isLocal: bJ.test(bW[1]), global: !0, type: "GET", contentType: "app/x-www-form-urlencoded", processData: !0, async: !0, accepts: {xml: "app/xml, text/xml", html: "text/html", text: "text/plain", json: "app/json, text/javascript", "*": bX}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": a.String, "text html": !0, "text json": f.parseJSON, "text xml": f.parseXML}, flatOptions: {context: !0, url: !0}}, ajaxPrefilter: bZ(bT), ajaxTransport: bZ(bU), ajax: function (a, c) {
        function w(a, c, l, m) {
            if (s !== 2) {
    ...
    f.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
        ...
        var e = b.contentType === "app/x-www-form-urlencoded" && typeof b.data == "string";
    ...
    }), f.ajaxSetup({accepts: {script: "text/javascript, app/javascript, app/ecmascript, app/x-ecmascript"}, contents: {script: /javascript|ecmascript/}, converters: {"text script": function (a) {
        f.globalEval(a);
        return a
